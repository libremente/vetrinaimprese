		...
		<c:choose>
			...
			<c:otherwise>
				...
				<c:if test="${empty parametriRicerca.textRicerca}">
					<div class="row">
						<div
							class="col-md-10 col-md-offset-1 col-sm-12 text-center homemt">
							<!-- <h2>TOP NEWS</h2> -->
							<p><spring:message code="home.personal.list.my_info" text="Le Mie informazioni"/>.</p>
						</div>
					</div>
				</c:if>
									...
									<div class="item-thumb">
										<c:choose>
											...
											<c:when test="${riga.idTipoInformazione == 3}">
												<h6 class="card-title">&nbsp;&nbsp;<spring:message code="home.list.services" text="Services"/></h6>
												<a
											...
											<c:when test="${riga.idTipoInformazione == 4}">
												<c:choose>
													...
													<c:when test="${riga.stato == 4}">
														<h6 class="card-title">&nbsp;&nbsp;<spring:message code="home.list.innovation" text="INNOVAZIONE"/></h6>
													</c:when>
												</c:choose>
												<a href="/vimp/detail/${riga.idTipoInformazione}/${riga.idInformazione}"><c:choose>
														<c:when test="${!empty riga.immagine}">
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-top">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/icona_prodotti.png" height="38" width="38"></span>--%>
									</div>
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-right">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/startup_lista_risultati.png" height="38" width="38"></span>--%>
									</div>
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-bottom">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/pmi_lista_risultati.png" height="38" width="38"></span>--%>
									</div>
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-left">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/icona_progetti.png" height="38" width="38"></span>--%>
									</div>
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-top">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/icona_spinf_off_azienda.png" height="38" width="38"></span>--%>
									</div>
							...
							<div class="col-sm-2 col-xs-5">
								<div class="count-item">
									<div class="count-item-circle counter-background-right">
										...
										<%--<span><img src="${evn_urlRisorseStatiche}/vimp/assets/img/ic/grandi_imprese_lista_risultati.png" height="38" width="38"></span>--%>
									</div>
