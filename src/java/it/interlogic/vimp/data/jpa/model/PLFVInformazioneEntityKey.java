...
@Embeddable
public class PLFVInformazioneEntityKey implements Serializable
{
	...
	@Column(name = "TIPO_INFORMAZIONE", nullable = false)
	private BigDecimal idTipoInformazione;

	// ----------------------------------------------------------------------
	// CONSTRUCTORS
	// ----------------------------------------------------------------------
	public PLFVInformazioneEntityKey()
	{
		super();
	}

	public PLFVInformazioneEntityKey(BigDecimal idInformazione, BigDecimal idTipoInformazione)
	{
		super();
	...
	public boolean equals(Object obj)
	{
		...
		if (this.getClass() != obj.getClass())
			return false;
		PLFVInformazioneEntityKey other = (PLFVInformazioneEntityKey) obj;
