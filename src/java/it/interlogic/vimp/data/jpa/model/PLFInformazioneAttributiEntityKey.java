...
@Embeddable
public class PLFInformazioneAttributiEntityKey implements Serializable
{
	...
	// CONSTRUCTORS
	// ----------------------------------------------------------------------
	public PLFInformazioneAttributiEntityKey()
	{
		super();
	}

	public PLFInformazioneAttributiEntityKey(BigDecimal idInformazione, BigDecimal idTipoInformazione)
	{
		super();
	...
	public boolean equals(Object obj)
	{
		...
		if (this.getClass() != obj.getClass())
			return false;
		PLFInformazioneAttributiEntityKey other = (PLFInformazioneAttributiEntityKey) obj;
