...
public class EnterprisePortTypeProxy implements it.interlogic.vimp.service.ws.aris.uisearch.EnterprisePortType {
  private String _endpoint = null;
  private it.interlogic.vimp.service.ws.aris.uisearch.EnterprisePortType enterprisePortType = null;
  ...
  private void _initEnterprisePortTypeProxy() {
    try {
      enterprisePortType = (new it.interlogic.vimp.service.ws.aris.uisearch.UlSearchLocator()).getEnterprisePort();
      if (enterprisePortType != null) {
        if (_endpoint != null)
  ...
  public it.interlogic.vimp.service.ws.aris.uisearch.EnterprisePortType getEnterprisePortType() {
    if (enterprisePortType == null)
      _initEnterprisePortTypeProxy();
    return enterprisePortType;
  }
  
  public it.interlogic.vimp.service.ws.aris.uisearch.UlSearchResult getUL(java.lang.String partitaIVA_codiceFiscale) throws java.rmi.RemoteException{
    if (enterprisePortType == null)
      _initEnterprisePortTypeProxy();
    return enterprisePortType.getUL(partitaIVA_codiceFiscale);
  }
